      ...
      * WRITE EACH BREED RESULTS INTO THE FINAL REPORT
           MOVE SHIBA-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(SHIBA-INDEX-VALUE)
               TO ADOPTED-AMOUNT in ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE SCHNAUZER-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(SCHNAUZER-INDEX-VALUE)
               TO ADOPTED-AMOUNT IN ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE CORGI-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(CORGI-INDEX-VALUE)
               TO ADOPTED-AMOUNT IN ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE CHI-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(CHI-INDEX-VALUE)
               TO ADOPTED-AMOUNT IN ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE POODLE-BREED-NAME TO DOG-BREED in ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(POODLE-INDEX-VALUE)
               TO ADOPTED-AMOUNT IN ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE POMERANIAN-BREED-NAME
               TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(POMERANIAN-INDEX-VALUE)
               TO ADOPTED-AMOUNT IN ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE BULLDOG-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(BULLDOG-INDEX-VALUE)
                TO ADOPTED-AMOUNT IN ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE JINGO-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
           MOVE BREED-ADOPTIONS(JINGO-INDEX-VALUE)
               TO ADOPTED-AMOUNT in ADOPTED-REPORT-REC.
           PERFORM WRITE-ADOPTION-BREED-REPORT.

           MOVE OTHER-BREED-NAME TO DOG-BREED IN ADOPTED-REPORT-REC.
